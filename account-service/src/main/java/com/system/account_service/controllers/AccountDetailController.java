...
//
//@RestController
//@RequestMapping("/api/v1/accounts/account_details")
//@RequiredArgsConstructor
//@Tag(name = "Account Detail API")
...
//
//    @GetMapping("")
//    @Operation(summary = "Get Account detail list pagination")
//    @ApiResponses(value = {
...
//            WebRequest request
//    ) {
//        PageDataDTO<AccountDetails> pageData = service.findAll(page, pageSize);
...
//            @ApiResponse(responseCode = "200", description = "Success", content =
//                    {@Content(mediaType = "application/json", schema =
//                    @Schema(implementation = AccountDetails.class))}),
//            @ApiResponse(responseCode = "400", description = "Bad Request", content =
//                    {@Content(schema = @Schema(implementation = String.class))}),
//            @ApiResponse(responseCode = "404", description = "Not Found", content =
//                    {@Content(schema = @Schema(implementation = String.class))}),
...
//            WebRequest request
//    ) {
//        AccountDetails data = service.findById(id);
//        HttpStatus status = HttpStatus.OK;
//        String msg = localeUtils.getLocaleMsg(MessageKeys.DATA_GET_SUCCESS, request);
//
//        return ResponseEntity
...
//
//    @PostMapping("")
//    @Operation(summary = "Create Account detail info")
//    @ApiResponses(value = {
...
//            @RequestBody @Valid CreateAccountDetailDTO data,
//            WebRequest request
//    ) {
//        AccountDetails createdData = service.create(data);
...
//
//    @DeleteMapping("/{id}")
//    @Operation(summary = "Delete Account detail info")
//    @ApiResponses(value = {
