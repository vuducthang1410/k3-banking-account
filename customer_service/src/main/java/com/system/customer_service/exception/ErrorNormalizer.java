...
import com.system.customer_service.dto.identity.KeyCloakError;
...
public class ErrorNormalizer {
    ...
    public ErrorNormalizer() {
        ...
        errorCodeMap.put("User exists with same phone", ErrorCode.USER_PHONE_EXISTED);
        errorCodeMap.put("User exists with same email", ErrorCode.USER_MAIL_EXISTED);
        errorCodeMap.put("Phone is missing", ErrorCode.PHONE_MANDATORY);
    }
