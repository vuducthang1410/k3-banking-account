...
public class TransactionController {
    ...
    public ResponseEntity<?> createTransaction(@RequestBody @Validated CreateNapasTransactionDTO create)
            throws MethodArgumentTypeMismatchException {

        return ResponseEntity.status(HttpStatus.CREATED).contentType(MediaType.APPLICATION_JSON)
                .body(transactionService.create(create));
    }
    ...
    public ResponseEntity<?> rollbackTransaction(@RequestBody @Validated NapasTransactionRollbackDTO rollback)
            throws MethodArgumentTypeMismatchException {
